...
const Home = () => {
    ...
    return (
        <div className="h-full flex flex-col bg-gray-50/30">
                ...
                <div className="flex gap-2 h-12">
                    {['active', 'used', 'expired'].map(f => (
                        <button
                            ...
                            className={`flex-1 rounded-md text-[10px] uppercase font-black transition-all ${homeFilter === f ? theme.primary + ' text-white shadow-md' : 'bg-gray-50 text-gray-400'}`}
                        >
                            {t(f)}
                        </button>
                    ))}
            ...
            <div className="flex-1 overflow-y-auto pt-4 space-y-4 pb-24 scrollbar-hide">
